...
public class DetallePedidoController {
	...
	public ResponseEntity<?> mostrar(@PathVariable Long id) {
		...
		if (detallePedido == null) {
			response.put("mensaje", "El detalle de pedido ID: ".concat(id.toString().concat(", no existe en la base de datos!")));
	...
	public ResponseEntity<?> delete(@PathVariable Long id) {
		...
		response.put("mensaje", "El detalle del pedido ha sido eliminado con éxito." );		
